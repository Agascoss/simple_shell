 ...
 *
 * Return: return 0 if success, errcode otherwise.
 */
 ...
 * @data: Pointer to the programs data.
 *
 * Return: return array of path directories.
 */
...
/**
 * check_file - Checks if exists a file, if it is not a dairectory.
 *
 * @full_path: Pointer to the file name.
 *
 * Return: return 0 on success, or error code if it exists.
 */
